...
namespace UniversityTransportation.Constants
{
    public class ConfigurationConstants
    {
        ...
        //public const string ConnectionString = @"Data Source = SQL5063.site4now.net; Initial Catalog = db_a75764_univtranspostaion; User Id = db_a75764_univtranspostaion_admin; Password=moh17471";

        public const string ConnectionString = @"Data Source=SQL5105.site4now.net;Initial Catalog=db_a78326_univtrandb;User Id=db_a78326_univtrandb_admin;Password=moh17471";
