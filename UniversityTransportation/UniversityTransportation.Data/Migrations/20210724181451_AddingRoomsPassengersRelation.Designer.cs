...
namespace UniversityTransportation.Data.Migrations
{
    ...
    [Migration("20210724181451_AddingRoomsPassengersRelation")]
    partial class AddingRoomsPassengersRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PassengerRoom", b =>
                {
                    ...
                    b.HasKey("PassengersId", "RoomsId");

                    b.HasIndex("RoomsId");

                    b.ToTable("PassengerRoom");
                });
            ...
            modelBuilder.Entity("PassengerRoom", b =>
                {
                    b.HasOne("UniversityTransportation.Data.Models.Accounts.Passenger", null)
                        .WithMany()
                        .HasForeignKey("PassengersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UniversityTransportation.Data.Models.Journey.Room", null)
                        .WithMany()
